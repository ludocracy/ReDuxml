require File.expand_path(File.dirname(__FILE__) + '/../lib/design_os')
require 'minitest/autorun'

class DuxerTest < MiniTest::Test
  SAMPLE_DUX = File.expand_path(File.dirname(__FILE__) + '/../xml/sample_dux.xml')
  RESULT_DUX = File.expand_path(File.dirname(__FILE__) + '/../xml/result_dux.xml')
