require File.expand_path(File.dirname(__FILE__) + '/../Dux/dux')
require File.expand_path(File.dirname(__FILE__) + '/ext/symja')
require File.expand_path(File.dirname(__FILE__) + '/ext/macro')
...
# generates new design tree from current dux, resolving parameter values and instantiating Instance objects, and pruning filtered components.
  def resolve
    grow!
    prune!
    current_dux
