#*********** PK - this is not our source!!! run a diff with the original after you get this working, then make the changes an extension file!!!
...
['symbolic/boolean.rb','symbolic/expression.rb','symbolic/coerced.rb','symbolic/constants.rb','symbolic/factors.rb',
